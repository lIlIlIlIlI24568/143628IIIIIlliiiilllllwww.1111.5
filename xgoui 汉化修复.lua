...
KeySys.Main.ElseDesc2.Text = "或者,您可以在https://discord.gg/sirius购买pro"
...
local UniversalScripts = {
    xgojp = {
		Name = "xgo 旧版本",
		Author = "xgo 进入旧版本模式",
		Loadstring = "https://raw.githubusercontent.com/lIlIlIlIlI24568/llllllljjjlllllllll.zyzyzy.lua/refs/heads/main/%F0%9F%95%8A%EF%B8%8F%F0%9F%95%8A%EF%B8%8F%F0%9F%95%8A%EF%B8%8F%F0%9F%95%8A%EF%B8%8F%F0%9F%95%8A%EF%B8%8F",
	    Colour = Color3.fromRGB(57, 57, 57),
	},
	xgov1 = {
		Name = "xgo 游戏中心v1",
		Author = "xgo 游戏v1",
		Loadstring = "https://raw.githubusercontent.com/lIlIlIlIlI24568/143628IIIIlllllliilililIIlll.YXZX.LUA/refs/heads/main/V1",
	    Colour = Color3.fromRGB(57, 57, 57),
	},
	xgov2 = {
		Name = "xgo 游戏中心v2",
    ...
    xgo = {
		Name = "xgo 主页",
		Author = "xgo 主页",
		Loadstring = "https://raw.githubusercontent.com/lIlIlIlIlI24568/14362llll364XXGOLLLk22222/refs/heads/main/goto",
	    Colour = Color3.fromRGB(57, 57, 57),
	},
}
...
function CloseScripts()
	...
	if not ThemeEnabled then
		local transitionInfo = TweenInfo.new(1.1, Enum.EasingStyle.Quint)
		local tween = TweenService:Create(Domain.Main.Buttons.ScriptsButton, transitionInfo, {BackgroundColor3 = Color3.fromRGB(56, 56, 56)})
		tween:Play()
		local transitionInfo = TweenInfo.new(1.1, Enum.EasingStyle.Quint)
		local tween = TweenService:Create(Domain.Main.Buttons.ScriptsButton.Interact, transitionInfo, {ImageColor3 = Color3.fromRGB(238, 238, 238)})
		tween:Play()
	end
	scriptsopen = false
	for _, AddedScript in ipairs(Domain.Scripts.List:GetChildren()) do
...
function CloseJC()
	...
	if not ThemeEnabled then
		local transitionInfo = TweenInfo.new(1.1, Enum.EasingStyle.Quint)
		local tween = TweenService:Create(Domain.Main.Buttons.JoinCodesButton, transitionInfo, {BackgroundColor3 = Color3.fromRGB(56, 56, 56)})
		tween:Play()
		local transitionInfo = TweenInfo.new(1.1, Enum.EasingStyle.Quint)
		local tween = TweenService:Create(Domain.Main.Buttons.JoinCodesButton.Interact, transitionInfo, {ImageColor3 = Color3.fromRGB(238, 238, 238)})
		tween:Play()
	end
...
function OpenPlayerlist()
	...
	if not ThemeEnabled then
		local transitionInfo = TweenInfo.new(1.1, Enum.EasingStyle.Quint)
		local tween = TweenService:Create(Domain.Main.Buttons.PlayersButton, transitionInfo, {BackgroundColor3 = Color3.fromRGB(238,238,238)})
		tween:Play()
		local transitionInfo = TweenInfo.new(1.1, Enum.EasingStyle.Quint)
		local tween = TweenService:Create(Domain.Main.Buttons.PlayersButton.Interact, transitionInfo, {ImageColor3 = Color3.fromRGB(56,56,56)})
		tween:Play()
	end
	plrlistopen = true
	if scriptsopen then
...
function ClosePlayerlist()
	...
	if not ThemeEnabled then
		local transitionInfo = TweenInfo.new(1.1, Enum.EasingStyle.Quint)
		local tween = TweenService:Create(Domain.Main.Buttons.PlayersButton, transitionInfo, {BackgroundColor3 = Color3.fromRGB(56, 56, 56)})
		tween:Play()
		local transitionInfo = TweenInfo.new(1.1, Enum.EasingStyle.Quint)
		local tween = TweenService:Create(Domain.Main.Buttons.PlayersButton.Interact, transitionInfo, {ImageColor3 = Color3.fromRGB(238, 238, 238)})
		tween:Play()
	end
	plrlistopen = false
	local transitionInfo = TweenInfo.new(0.5, Enum.EasingStyle.Quint)
...
function OpenHome()
	if not homedb and DMNReady then
		...
		if not ThemeEnabled then
			local transitionInfo = TweenInfo.new(1.1, Enum.EasingStyle.Quint)
			local tween = TweenService:Create(Domain.Main.Buttons.HomeButton, transitionInfo, {BackgroundColor3 = Color3.fromRGB(238,238,238)})
			tween:Play()
			local transitionInfo = TweenInfo.new(1.1, Enum.EasingStyle.Quint)
			local tween = TweenService:Create(Domain.Main.Buttons.HomeButton.Interact, transitionInfo, {ImageColor3 = Color3.fromRGB(56,56,56)})
			tween:Play()
		end
		homedb = true
		homeopen = true
...
function CloseHome()
	if not homedb then
		...
		if not ThemeEnabled then
			local transitionInfo = TweenInfo.new(1.1, Enum.EasingStyle.Quint)
			local tween = TweenService:Create(Domain.Main.Buttons.HomeButton, transitionInfo, {BackgroundColor3 = Color3.fromRGB(56, 56, 56)})
			tween:Play()
			local transitionInfo = TweenInfo.new(1.1, Enum.EasingStyle.Quint)
			local tween = TweenService:Create(Domain.Main.Buttons.HomeButton.Interact, transitionInfo, {ImageColor3 = Color3.fromRGB(238, 238, 238)})
			tween:Play()
		end
		local transitionInfo = TweenInfo.new(0.5, Enum.EasingStyle.Quint)
...
function OpenJC()
	...
	if not ThemeEnabled then
		local transitionInfo = TweenInfo.new(1.1, Enum.EasingStyle.Quint)
		local tween = TweenService:Create(Domain.Main.Buttons.JoinCodesButton, transitionInfo, {BackgroundColor3 = Color3.fromRGB(238,238,238)})
		tween:Play()
		local transitionInfo = TweenInfo.new(1.1, Enum.EasingStyle.Quint)
		local tween = TweenService:Create(Domain.Main.Buttons.JoinCodesButton.Interact, transitionInfo, {ImageColor3 = Color3.fromRGB(56,56,56)})
		tween:Play()
	end
...
Domain.Main.Buttons.HomeButton.Interact.MouseButton1Click:Connect(function()
	local transitionInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quint)
	local tween = TweenService:Create(Domain.Main.Buttons.HomeButton, transitionInfo, {Size = UDim2.new(0.081, 0,0.559, 0)})
	tween:Play()
	wait(0.2)
	local transitionInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quint)
	local tween = TweenService:Create(Domain.Main.Buttons.HomeButton, transitionInfo, {Size = UDim2.new(0.093, 0,0.647, 0)})
	tween:Play()
	if homeopen then
		CloseHome()
	else
...
Domain.Main.Buttons.PlayerButton.Interact.MouseButton1Click:Connect(function()
	local transitionInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quint)
	local tween = TweenService:Create(Domain.Main.Buttons.PlayerButton, transitionInfo, {Size = UDim2.new(0.081, 0,0.559, 0)})
	tween:Play()
	wait(0.2)
	local transitionInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quint)
	local tween = TweenService:Create(Domain.Main.Buttons.PlayerButton, transitionInfo, {Size = UDim2.new(0.093, 0,0.647, 0)})
	tween:Play()
	if not db then
		if plrconopen then
			ClosePlayerConfig()
...
Domain.Main.Buttons.PlayersButton.Interact.MouseButton1Click:Connect(function()
	local transitionInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quint)
	local tween = TweenService:Create(Domain.Main.Buttons.PlayersButton, transitionInfo, {Size = UDim2.new(0.081, 0,0.559, 0)})
	tween:Play()
	wait(0.2)
	local transitionInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quint)
	local tween = TweenService:Create(Domain.Main.Buttons.PlayersButton, transitionInfo, {Size = UDim2.new(0.093, 0,0.647, 0)})
	tween:Play()
...
Domain.Main.Buttons.JoinCodesButton.Interact.MouseButton1Click:Connect(function()
	local transitionInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quint)
	local tween = TweenService:Create(Domain.Main.Buttons.JoinCodesButton, transitionInfo, {Size = UDim2.new(0.081, 0,0.559, 0)})
	tween:Play()
	wait(0.2)
	local transitionInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quint)
	local tween = TweenService:Create(Domain.Main.Buttons.JoinCodesButton, transitionInfo, {Size = UDim2.new(0.093, 0,0.647, 0)})
	tween:Play()
	if not db and DMNReady then
		if jcopen then
			CloseJC()
...
Domain.Main.Buttons.ScriptsButton.Interact.MouseButton1Click:Connect(function()
	local transitionInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quint)
	local tween = TweenService:Create(Domain.Main.Buttons.ScriptsButton, transitionInfo, {Size = UDim2.new(0.081, 0,0.559, 0)})
	tween:Play()
	wait(0.2)
	local transitionInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quint)
	local tween = TweenService:Create(Domain.Main.Buttons.ScriptsButton, transitionInfo, {Size = UDim2.new(0.093, 0,0.647, 0)})
	tween:Play()
	if not db and DMNReady then
		if scriptsopen then
			CloseScripts()
